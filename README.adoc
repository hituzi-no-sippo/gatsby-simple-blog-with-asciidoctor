...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch feat/change-SEO v1.1.0 (Base v1.27.0)
:revdate: 2020-01-10T23:51:44+0900
:revremark: Add change point to SEO section that add `twitter:site` in meta
:doctype: article
