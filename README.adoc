...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch docs/update-demo-and-README v1.0.1 (Base v1.50.0)
:revdate: 2020-02-29T16:21:21+0900
:revremark: The table of delete plugins is easier to see.
:doctype: article
