...
:!email: {author-email}
:revnumber: v1.52.0
:revdate: 2020-02-29T20:34:38+0900
:revremark: Update netlify build command message.
:doctype: article
...
[NOTE]
====
The netlify build command is changed to `yarn build` with link:./netlify.toml[
netlify.toml^].
====
