...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch feat/display-author v1.1.0 (Base v1.37.0)
:revdate: 2020-01-25T19:03:04+0900
:revremark: Add Profile Picture Link section.
:doctype: article
...
|url     |Not use        |Not use           |No
|twitter |social.twitter |Not use           |No
|====================================================

The `author.url` is used xref:profile-picture-link[profile picture].
