...
:!email: {author-email}
:revnumber: v1.4.0
:revdate: 2019-12-08T00:11:20+0900
:revremark: Add profile picture license
:doctype: article
...
Profile picture] (used in `src/components/LangButton/IconLanguage.js`) is
licensed under {cc0-10-link}.

link:http://www.evericons.com[
Language icon] (`content/assets/profile-pic.jpg`) is
licensed under {cc0-10-link}.
