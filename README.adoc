...
:!email: {author-email}
:revnumber: v1.26.2
:revdate: 2020-01-09T21:57:07+0900
:revremark: Add description of the case where repository link is not displayed.
:doctype: article
...
If `siteMetadata.articles.dir` is `''` (default), don't add a link.
