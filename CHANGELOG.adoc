...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch feat/change-disqus v1.2.0. (Base v1.55.0)
:revdate: 2020-01-20T07:40:10+0900
:revremark: Add log that change the default display setting of disqus \
