...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch docs/update-demo-and-README v1.1.0 (Base v1.95.0)
:revdate: 2020-02-29T16:17:08+0900
:revremark: Add log that make image link open to a new window in README.
:doctype: article
