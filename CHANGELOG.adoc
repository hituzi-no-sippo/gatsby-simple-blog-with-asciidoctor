...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch docs/update-demo-and-README v1.0.0 (Base v1.95.0)
:revdate: 2020-02-29T16:14:31+0900
:revremark: Add log that Make `linksInBio` use `author` in `cofig/index.js`.
:doctype: article
