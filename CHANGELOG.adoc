...
:!email: {author-email}
:revnumber: v1.21.0
:revdate: 2019-12-09T23:46:19+0900
:revremark: Add log that add asciidoc examples article
:doctype: article
...
* Change element of blog text to `article`. (close link:{issues-url}/31[#31])
