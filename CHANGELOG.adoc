...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch feat/change-theme-icon-positons v1.0.0 (Base v1.54.0)
:revdate: 2020-01-19T14:09:42+0900
:revremark: Add log that fix typo \
            `pageAttributes.description` to `pageAttributes.disqus` in README
:doctype: article
