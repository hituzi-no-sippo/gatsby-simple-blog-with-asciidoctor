...
:!email: {author-email}
:revnumber: v1.58.0
:revdate: 2020-01-21T12:45:01+0900
:revremark: Add log that tag list position in index \
            to under the line starting from update date.
:doctype: article
