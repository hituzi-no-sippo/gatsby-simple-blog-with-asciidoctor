...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch feat/add-relationship-attributes-in-anchor-elements v1.0.0 \
            (Base v1.66.0)
:revdate: 2020-01-25T11:06:38+0900
:revremark: Add log that \
            add `author` and `external` of relationship attribute in bio links.
:doctype: article
