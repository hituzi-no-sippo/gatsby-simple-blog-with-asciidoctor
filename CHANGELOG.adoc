...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch docs/update-demo-and-README v1.2.0 (Base v1.95.0)
:revdate: 2020-02-29T16:20:58+0900
:revremark: Add log that make the table of delete plugins easy to see.
:doctype: article
