...
:!email: {author-email}
:revnumber: v1.31.0
:revdate: 2019-12-26T12:46:44+0900
:revremark: Add log that make submodule from sample articles
:doctype: article
...
* Make submodule from sample articles. (close link:{issues-url}/83[#83]) +
  link:https://github.com/hitsuji-no-shippo/sample-articles-for-asciidoctor/commit/bb4b82a2bf8817b7545cdf6f1b7e81cacb957a26[
       submodule^]
