...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch feat/change-disqus v1.3.0. (Base v1.55.0)
:revdate: 2020-01-20T07:40:42+0900
:revremark: Add log that add accessory Informations of article component.
:doctype: article
