...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch docs/update-log-in-CHANGELOG v1.0.0 (Base v1.49.0)
:revdate: 2020-01-11T15:02:40+0900
:revremark: Delete log that add default values to `siteMetadata.repository`
:doctype: article
