...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch feat/add-relationship-attributes-in-anchor-elements v1.2.0 \
            (Base v1.66.0)
:revdate: 2020-01-25T11:08:39+0900
:revremark: Add log that \
            add `alternate` of realtionship attribute in translation links.
:doctype: article
...
* `time` => `timeToRead`
--
* Collet `LanguageBar` component codes. (close link:{issues-url}/155[#155^])
