...
:!email: {author-email}
:revnumber: v1.31.1
:revdate: 2019-12-26T13:00:50+0900
:revremark: Fix submodule link for sample articles
:doctype: article
...
* Make submodule from sample articles. (close link:{issues-url}/83[#83]) +
  link:https://github.com/hitsuji-no-shippo/sample-articles-for-asciidoctor/tree/bb4b82a2bf8817b7545cdf6f1b7e81cacb957a26[
       submodule^]
