...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch feat/add-relationship-attributes-in-anchor-elements v1.1.0 \
            (Base v1.66.0)
:revdate: 2020-01-25T11:07:27+0900
:revremark: Add log that collet `LanguageBar` component codes.
:doctype: article
