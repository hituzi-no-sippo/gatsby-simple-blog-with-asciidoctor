...
:!email: {author-email}
:revnumber: v1.26.0
:revdate: 2019-12-24T22:35:29+0900
:revremark: Add log that automatically add `dir-path-from-project` attribute
:doctype: article
...
--
.Update package
* link:{gatasby-transformer-asciidoc-url}[gatasby-transformer-asciidoc^] +
